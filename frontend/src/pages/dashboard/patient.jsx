                    ...
                    <nav className="flex-1 space-y-2">
                        {navItems.map((item) => (
                            <button
                                ...
                                className={`w-full flex items-center gap-4 px-5 py-4 rounded-3xl text-sm font-bold tracking-tight transition-all duration-300 relative group overflow-hidden ${activeTab === item.id
