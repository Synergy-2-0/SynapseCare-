            ...
            <div className="surface-card bg-white p-8 xl:p-12 min-h-[600px] flex flex-col">
                <div className="flex border-b border-slate-100 mb-8 overflow-x-auto">
                    ...
                    <button 
                        ...
                        className={`px-8 py-4 text-xs font-black uppercase tracking-[0.2em] transition-all whitespace-nowrap ${activeTab === 'history' ? 'text-indigo-600 border-b-2 border-indigo-600 bg-indigo-50/30' : 'text-slate-400 hover:text-slate-600 hover:bg-slate-50'}`}
                    >
                        ...
                        <table className="w-full text-left border-separate border-spacing-y-4">
                            ...
                            <tbody>
                                {prescriptions.map((px, i) => (
                                    <tr key={i} className="group hover:-translate-y-1 transition-transform">
                                        <td className="bg-slate-50 group-hover:bg-white border-y border-l border-slate-100 group-hover:border-indigo-200 rounded-l-[1.5rem] p-5 group-hover:shadow-xl group-hover:shadow-indigo-500/5">
                                        ...
                                        <td className="bg-slate-50 group-hover:bg-white border-y border-r border-slate-100 group-hover:border-indigo-200 rounded-r-[1.5rem] p-5 group-hover:shadow-xl group-hover:shadow-indigo-500/5 text-right">
                                            <button 
