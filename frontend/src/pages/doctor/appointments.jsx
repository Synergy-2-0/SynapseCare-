            ...
            <div className="space-y-6">
                <section className="bg-white border border-slate-100 rounded-3xl p-6 shadow-sm">
                    <div className="flex flex-col gap-1">
                        <h1 className="text-2xl font-black tracking-tight text-slate-900">Appointments Workspace</h1>
                        <p className="text-sm font-medium text-slate-500">Select a date, review the timeline, then action incoming requests on the right.</p>
                    </div>
                </section>
                ...
                <div className="grid grid-cols-1 xl:grid-cols-3 gap-6">
                    ...
                    <div className="xl:col-span-2 space-y-6">
                        ...
                        {/* Banner */}
                        <div className="bg-gradient-to-br from-teal-50 to-cyan-50 border border-teal-100 rounded-3xl p-8 flex items-start justify-between overflow-hidden relative min-h-[170px]">
                            <div className="z-10">
                                <h2 className="text-2xl font-black tracking-tight text-slate-800 leading-tight">
                                    Plan Your Daily Queue
                                </h2>
                                <p className="text-sm text-slate-600 font-medium mt-2 max-w-sm">Create new slots and keep today&apos;s consultations balanced across the timeline.</p>
                                <button className="mt-5 flex items-center gap-2 bg-teal-600 hover:bg-teal-700 text-white px-5 py-2.5 rounded-xl text-sm font-bold transition-all shadow-md shadow-teal-500/20 active:scale-95">
                        ...
                        <div className="bg-white rounded-3xl border border-slate-100 p-6 shadow-sm">
                            <div className="flex items-center justify-between mb-5">
                                <div>
                                    ...
                                    <p className="text-xs text-slate-500 mt-1">Choose a day to load its appointment timeline.</p>
                                </div>
                                ...
                                {calendarDays.map((date, idx) => {
                                    ...
                                    return (
                                        <button
                                            ...
                                            className={`relative flex flex-col items-center justify-center py-3 rounded-2xl transition-all text-sm font-semibold
                                            ${isSelected
                        ...
                        <div className="bg-white rounded-3xl border border-slate-100 p-6 shadow-sm">
                            <div className="flex items-center justify-between mb-6">
                                <h3 className="font-bold text-slate-800 text-lg">Daily Timeline</h3>
                            ...
                            {timelineAppointments.length > 0 ? (
                                                            ...
                                                            <div className="flex gap-4 items-center">
                                                                {appt.meetingLink && appt.consultationType === 'TELEMEDICINE' && (
                                                                    <a
                                                                        ...
                                                                        target="_blank"
                                                                        rel="noreferrer"
                                                                        className="text-[10px] font-bold text-teal-600 hover:text-teal-700 flex items-center gap-1 bg-teal-50 px-2 py-1 rounded-md border border-teal-100"
                                ...
                                <div className="text-center py-14">
                                    ...
                                    <p className="text-slate-400 text-xs mt-1">Select another day or review pending requests on the right.</p>
                                </div>
                            )}
                        </div>
                    </div>
                        ...
                        <div className="bg-white rounded-3xl border border-slate-100 p-7 shadow-sm">
                            ...
                            <div className="space-y-5">
                                <div>
                                    ...
                                    <p className="text-4xl font-black text-slate-800 tabular-nums">{totalCount}</p>
                                </div>
                                <div className="h-px bg-slate-100" />
                                <div>
                                    <p className="text-xs text-slate-400 font-medium mb-1">Pending</p>
                                    <p className="text-4xl font-black text-rose-500 tabular-nums">{pendingCount}</p>
                                </div>
                                <div className="h-px bg-slate-100" />
                                <div>
                                    <p className="text-xs text-slate-400 font-medium mb-1">Completed</p>
                                    <p className="text-4xl font-black text-emerald-500 tabular-nums">{doneCount}</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="bg-white rounded-3xl border border-slate-100 p-6 shadow-sm">
                            <div className="flex items-center justify-between mb-5">
                                <div>
                                    ...
                                    <p className="text-xs text-slate-500 mt-1">Approve or decline patient booking requests.</p>
                                </div>
                            </div>
                            ...
                            <div className="space-y-3 max-h-[calc(100vh-24rem)] overflow-y-auto pr-1 custom-scrollbar">
                                {pendingRequests.length > 0 ? pendingRequests.map(appt => {
                                    ...
                                    <div className="text-center py-12 opacity-50">
                                        ...
                                        <p className="text-sm font-semibold text-slate-500">All clear — no pending requests</p>
                                    </div>
                                )}
                            </div>
                        </div>
